...
class Infogram extends Shortcode
{
	...
	public static function get_shortcode_ui_args() {
		return array(
			'label'          => esc_html__( 'Infogram', 'uw-shortcake' ),
			'listItemImage' => '<img width="100px" height="100px" src="' . esc_url( UW_SHORTCAKE_URL_ROOT . 'assets/images/svg/icon-infogram.svg' ) . '" />',
			'attrs'          => array(
				array(
					'label'        => esc_html__( 'URL', 'uw-shortcake' ),
					'attr'         => 'url',
					'type'         => 'text',
					'description'  => esc_html__( 'URL to the Infogram', 'uw-shortcake' ),
				),
			),
		);
	}
