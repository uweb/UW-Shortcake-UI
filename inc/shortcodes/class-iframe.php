...
class Iframe extends Shortcode {
	...
	public static function get_shortcode_ui_args() {
		return array(
			'label'          => esc_html__( 'Iframe', 'uw-shortcake' ),
			...
			'attrs'          => array(
				array(
					...
					'attr'         => 'src',
					'type'         => 'text',
					'description'  => esc_html__( 'Full URL to the iFrame source. Host must be whitelisted.', 'uw-shortcake' ),
				),
			),
		);
	}
	...
	*/
	public static function get_whitelisted_iframe_domains() {
		return apply_filters( 'uw-shortcake_whitelisted_iframe_domains', array() );
	}
